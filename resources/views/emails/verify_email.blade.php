...
<head>
    ...
    <title>Verify Your Email - Gautam Real Estate</title>
    <style>
        body {
...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <!-- Main Content -->
            <div class="content">
                <div class="greeting">Welcome, {{ $user->first_name }} {{ $user->last_name }}!</div>
                <div class="text">
                    Thank you for registering on the Gautam Real Estate investor portal. To activate your accredited investment profile and complete your fractional deed initialization, please confirm your email address by clicking the button below:
                </div>
